...
<pre>
<code>define &lt;devicename&gt; Buienradar [latitude] [longitude]
</code>
</pre>
...
<pre>
<code>define &lt;devicename&gt; Buienradar
</code>
</pre><span id="Buienradarget">
...
<ul>
  ...
  <li><code>testVal</code> - converts the gathered values from the old Buienradar <abbr>API</abbr> to mm/m&Acirc;&sup2;. <strong>Obsolete!</strong></li>
</ul><span id="Buienradarreadings">
...
</ul><span id="Buienradarattr">

<h3 id="attributes">Attributes</h3>

<ul>
  <li><a name="disabled" id="disabled"></a> <code>disabled on|off</code> - If <code>disabled</code> is set to <code>on</code>, no further requests to Buienradar.nl will be performed. <code>off</code> reactivates the device, also if the attribute ist simply deleted.</li>

  <li><a name="region" id="region"></a> <code>region nl|de</code> - Allowed values are <code>nl</code> (default value) and <code>de</code>. In some cases, especially in the south and east of Germany, <code>de</code> returns values at all.</li>

  <li><a name="interval" id="interval"></a> <code>interval 10|60|120|180|240|300</code> - Data update every <var>n</var> seconds. <strong>Attention!</strong> 10 seconds is a very aggressive value and should be chosen carefully, <abbr>e.g.</abbr> when troubleshooting. The default value is 120 seconds.</li>
</ul>
...
<ul>
  <li>
    ...
    <pre>
<code>  { FHEM::Buienradar::HTML("buienradar device name")}
</code>
</pre>
  ...
  <li>
    ...
    <pre>
<code>  { FHEM::Buienradar::GChart("buienradar device name")}
</code>
</pre>
  ...
  <li>
    ...
    <pre>
<code>  { FHEM::Buienradar::LogProxy("buienradar device name")}
</code>
</pre>
  </li>
  ...
  <li>
    ...
    <pre>
<code>  { FHEM::Buienradar::TextChart("buienradar device name")}
</code>
</pre>
...
<code>  23:00 |  11.800 | ==================================================&gt;
  ...
  <li>
    ...
    <pre>
<code>  { FHEM::Buienradar::ColourBarChart("buienradar device name") }
</code>
</pre>
